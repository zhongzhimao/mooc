...
`;
        ...
        domooc.bindGetAnswer = function(obj) {
            ...
            $('div.j-title.title div.f-richEditorText.j-richTxt').each((idx, ele) => {
                ...
                let btn = $(`<p data-${names.qid}="${quizs[idx].id}" id="${domooc.getanswerbyidstr}" style="background:rgba(160,255,80,${usersetting.answerbtnbgcolor ? 0.3 : 0});${usersetting.showanswerbtn || (document.location.href.indexOf('hw') > -1) ? '' : 'display:none;'}""><a class="f-fcgreen"  >${dstrings.showans}</a></p>`);
